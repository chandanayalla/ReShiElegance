...
const AdminSidebar = ({ isOpen = false, onClose = () => {} }) => {
  ...
  return (
    <aside className={`admin-sidebar p-4 ${isOpen ? 'is-open' : ''}`}>
      <button type="button" className="admin-sidebar-close" aria-label="Close admin menu" onClick={onClose}>
      ...
      <nav className="nav flex-column gap-2">
        ...
        <NavLink to="/admin/products" className="nav-link" onClick={onClose}>
          <i className="bi bi-box-seam me-2"></i>Products
        </NavLink>
        <NavLink to="/admin/orders" className="nav-link" onClick={onClose}>
